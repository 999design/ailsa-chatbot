...
const script = {
	...
	B1: {
		text: 	'Do you rent from a private landlord or a letting agent?', 
		options: {
			'Yes': 										'C1',
	...
	C1: {
		text: 	'Did you sign your tenancy agreement/move in before 1st December 2017?', 
		options: {
			'Yes': 			'na',
			'No, after': 	'D1'
		}
	...
	D1: {
		text: 	'OK, that means PRT applies to you. What would you like to know more about?', 
		options: {
